...
const products: Product[] = [
  { id: 'neon-drip', name: 'Neon Drip', kind: 'case_motif', price: 20000, description: 'Tekstur soft-touch dengan karakter neon yang berani.', tag: 'Best seller', accent: 'violet', colors: JSON.stringify(['Black', 'White', 'Beige']), image_url: '/neon-drip-black.png' },
  { id: 'dragon-duo', name: 'Dragon Duo', kind: 'case_motif', price: 20000, description: 'Relief naga 3D untuk statement piece yang ikonik.', tag: 'Limited', accent: 'blue', colors: JSON.stringify(['Black', 'White', 'Beige']), image_url: '/dragon-duo-black.png' },
  { id: 'your-name', name: 'Your Name', kind: 'case_custom', price: 25000, description: 'Nama kamu, di-emboss langsung ke case favoritmu.', tag: 'Custom', accent: 'lime', colors: JSON.stringify(['Black', 'White', 'Beige']), image_url: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/ChatGPT%20Image%20Sep%205%2C%202026%20at%2009_49_25%20PM-vYnuJFMY7Ne117XB3x1tj5GZsxzgkL.png' },
  ...
  { id: 'monkey-freak', name: 'Monkey Freak', kind: 'case_motif', price: 20000, description: 'Monyet liar dengan ekspresi freak yang unik.', tag: 'Trendy', accent: 'cyan', colors: JSON.stringify(['Black', 'White', 'Beige']), image_url: '/monkey-freak-v2.png' },
  ...
  { id: 'viking-skull', name: 'Viking Skull', kind: 'case_motif', price: 20000, description: 'Tengkorak Viking dengan detail helm yang garang.', tag: 'Bold', accent: 'dark', colors: JSON.stringify(['Black', 'White', 'Beige']), image_url: '/viking-skull-v2.png' },
