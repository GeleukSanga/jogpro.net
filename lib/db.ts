...
const products: Product[] = [
  ...
  { id: 'koi', name: 'Koi', kind: 'case_motif', price: 20000, description: 'Ikan koi elegan dengan detail sirip yang dinamis.', tag: 'New', accent: 'orange', colors: JSON.stringify(['Orange', 'White', 'Gold']), image_url: '/koi-v2.png' },
