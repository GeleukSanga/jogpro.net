...
const products: Product[] = [
  ...
  { id: 'koi', name: 'Koi', kind: 'case_motif', price: 20000, description: 'Ikan koi elegan dengan detail sirip yang dinamis.', tag: 'New', accent: 'orange', colors: JSON.stringify(['Orange', 'White', 'Gold']), image_url: '/921497f19e75f121.png.png' },
  { id: 'monkey-freak', name: 'Monkey Freak', kind: 'case_motif', price: 20000, description: 'Monyet liar dengan ekspresi freak yang unik.', tag: 'Trendy', accent: 'cyan', colors: JSON.stringify(['Cyan', 'Black', 'White']), image_url: '/6d1ae703b608c1eb.jpg.png' },
  { id: 'o-sign', name: 'O-Sign', kind: 'case_motif', price: 20000, description: 'Desain simbol O dengan aksen metalik yang elegan.', tag: 'Premium', accent: 'gold', colors: JSON.stringify(['Gold', 'Black', 'Silver']), image_url: '/2025-08-31_4972dd651a843.png.png' },
  ...
  { id: 'hawaii', name: 'Hawaii', kind: 'case_motif', price: 20000, description: 'Nuansa tropis Hawaii dengan motif bunga yang ceria.', tag: 'Exclusive', accent: 'green', colors: JSON.stringify(['Green', 'Pink', 'White']), image_url: '/23fcfb9d6e05a4a3.jpg.png' },
