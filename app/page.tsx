...
const products = [
  ...
  },
  {
    ...
    tag: 'New',
    accent: 'orange',
    description: 'Desain api misterius dengan efek metalik yang memukau.',
  },
  {
    id: 'cyber-skull',
    name: 'Cyber Skull',
    ...
    tag: 'Trendy',
    accent: 'cyan',
    description: 'Tengkorak futuristik dengan sentuhan neon cyberpunk.',
  },
  {
    id: 'dragon-royal',
    name: 'Dragon Royal',
    ...
    tag: 'Premium',
    accent: 'gold',
    description: 'Naga kerajaan dengan detail emas yang elegan.',
  },
  {
    id: 'shadow-beast',
    name: 'Shadow Beast',
    ...
    tag: 'Bold',
    accent: 'dark',
    description: 'Makhluk bayangan dengan desain gelap yang intens.',
  },
  {
    id: 'neon-viper',
    name: 'Neon Viper',
    ...
    tag: 'Exclusive',
    accent: 'green',
    description: 'Ular neon dengan efek fluorescent yang menarik.',
  },
  {
    id: 'fire-dragon',
    name: 'Fire Dragon',
    ...
    tag: 'Hot',
    accent: 'red',
    description: 'Naga api dengan detail nyala yang hidup.',
  },
  {
    id: 'cosmic-warrior',
    name: 'Cosmic Warrior',
    ...
    tag: 'Space',
    accent: 'purple',
    description: 'Prajurit kosmik dengan desain futuristik antariksa.',
  },
]
