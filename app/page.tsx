  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#fbfbf8] text-[#171717]">
      ...
      <section id="top" className="relative z-10 mx-auto grid max-w-7xl items-center gap-10 px-5 pb-20 pt-12 sm:px-8 md:grid-cols-[1fr_0.9fr] md:pb-28 md:pt-20 lg:px-10">
        ...
        <div className="hero-product-wrap"><div className="hero-ring ring-one" /><div className="hero-ring ring-two" /><div className="floating-chip chip-one"><Zap className="size-3 fill-current" /> tactile finish</div><div className="floating-chip chip-two">01 / 04</div><div className="hero-product"><img src={products[0].heroImage} alt="Case Neon Drip dengan korek api menyala" /><div className="shine" /></div><div className="spark spark-1" /><div className="spark spark-2" /><div className="spark spark-3" /><div className="spark spark-4" /><div className="spark spark-5" /></div>
      </section>
